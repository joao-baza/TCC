...
\textit{Uvicorn} & Servidor ASGI para rodar aplicações \textit{web} assíncronas em \textit{Python}. & Executa o servidor da \textit{API FastAPI}, processando as requisições dos cálculos. \\ \hline
