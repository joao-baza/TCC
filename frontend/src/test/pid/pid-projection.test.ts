...
function createPopulatedDocument(): PidDocument {
  return {
    ...
    edges: {
      [ids.edge]: { id: ids.edge, sourcePortId: ids.sourcePort, targetPortId: ids.targetPort, connectionClass: "process", route: [{ x: 110, y: 20 }], tag: "L-100", label: "Linha", properties: { nested: { value: "edge" } } },
    },
    annotations: {
