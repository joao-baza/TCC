...
function baseDocument(): PidDocument {
  return {
    ...
    edges: {
      [ids.edge]: { id: ids.edge, sourcePortId: ids.pumpOut, targetPortId: ids.tankIn, connectionClass: "process", lineStyle: "supply-impulse", route: [], tag: "L-1", label: "Linha", properties: {} },
    },
    annotations: {},
    groups: {},
  };
