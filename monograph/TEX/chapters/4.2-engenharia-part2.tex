...
Em serviços de água a escoamento turbulento, a fórmula empírica de Hazen--Williams é comumente empregada como aproximação prática \cite{perry2007}. Temperatura e pressão afetam densidade e viscosidade do fluido, modificando o valor de $Re$ e, consequentemente, as perdas de carga.
...
Onde $D$ é o diâmetro hidráulico, $\rho$ é a densidade do fluido, $V$ é a velocidade média e $\mu$ é a viscosidade dinâmica. Tipicamente, $Re < 2300$ indica regime laminar, $2300 < Re < 4000$ indica regime de transição, e $Re > 4000$ indica regime turbulento plenamente desenvolvido \cite{white2018}.
