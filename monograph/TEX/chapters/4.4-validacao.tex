...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{media/cap4_lista_acessorios_json.png}
    \fonte{Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{media/cap4_especificacao_cotovelo_raio_longo_json.png}
    \fonte{Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{media/cap4_lista_materiais_tubulacao_json.png}
    \fonte{Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{media/cap4_especificacao_aco_comercial_json.png}
    \fonte{Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Lista de classes de pressão (\textit{Schedules}) disponíveis (JSON)}
    \includegraphics[width=\linewidth]{media/cap4_lista_schedules_json.png}
    \fonte{Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\linewidth]{media/cap4_lista_diametros_sch40_json.png}
    \fonte{Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{media/cap4_especificacao_tubo_sch40_dn50_json.png}
    \fonte{Autoria própria.}
\end{figure}
