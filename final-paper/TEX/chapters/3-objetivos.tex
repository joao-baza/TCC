...
\begin{itemize}
    ...
    \item Integrar um banco de dados local inicial com propriedades físico-químicas de substâncias comuns (coeficientes de difusão, calor específico, entalpia de vaporização etc.);
