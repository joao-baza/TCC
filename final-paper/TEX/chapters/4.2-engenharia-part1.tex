...
\end{equation}
em que $N_{i0}$ é a vazão molar de entrada do componente $i$ e $N_{u0}$ é seu coeficiente estequiométrico. O reagente com menor valor de ${razao}_{i}$ é o limitante \cite{felder2005}.
