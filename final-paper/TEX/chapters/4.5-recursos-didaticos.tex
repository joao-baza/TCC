...
\begin{figure}[H]
    \centering
    \caption{Recorte do painel do diagrama de \textit{Moody} com o ponto operacional destacado}
    \imgouplaceholder{media/cap4_moody_ponto_operacional_recorte.png}
    \fonte{Elaboração própria (2026).}
    \label{fig:viz_moody}
\end{figure}
...
\begin{figure}[H]
    ...
    \imgouplaceholder{media/cap7_21_reatores_levenspiel_exemplo.png}
    \fonte{Elaboração própria (2026).}
